...
const Navbar = ({activeTab, setActiveTab}) => {
  return (
    <>
    {/* Desktop Navigation */}
    <div className="fixed bottom-3 left-0 right-0 bg-white shadow-md p-3 mx-4 rounded-full flex justify-around items-center md:hidden border-2">
    ...
    {/* Mobile Navigation */}
    <div className="fixed bottom-3 left-0 right-0 bg-white shadow-md p-3 mx-4 rounded-full flex justify-around items-center">
      <button onClick={()=>setActiveTab('home')} className={`flex items-center gap-2 font-bold ${activeTab === 'home'?'':''}`}>
        <Image src="icons/victorylogo.svg" alt="Home" width={24} height={24} />
        <span className="text-sm">Home</span>
      </button>
